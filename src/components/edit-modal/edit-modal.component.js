...
const EditModal = (props) => {
  ...
  return (
    <form className={styles.modal} onSubmit={submitEditForm}>
      <header>
        <strong className={styles.modalHead}>You are editing {selectedTask.name}</strong>
        ...
        <label className={styles.smallMarginRight}>
          Due Date:
          <input name="dueDate" type="date" onChange={editTask} className={styles.marginRight}></input>
        </label>
        <label className={styles.smallMarginRight}>
          Priority:
